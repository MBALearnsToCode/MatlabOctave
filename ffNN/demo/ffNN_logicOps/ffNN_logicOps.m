...
% operations NOT, AND, OR and complicated combinations
% of such operations 

function [ffNN X y]= ffNN_logicOps(trainMethod = 'conjGrad')
...
targetOutputs_areClassIndcsColVecs_ofNumClasses = false, ...
            ...
            validCostCalcInterval_numChunks = 1, ...
            stepRate_init = learningRate, ...
            decayRate_init = 9e-1, momentumRate_init = 0, ...
            nesterovAccGrad = true, offsetTerm = 1e-6, ...
            weightRegulArgs_list = {{'L2'} [0]}, ...
            connectProbs = 1);
