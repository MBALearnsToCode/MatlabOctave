function [ffNN_updated ...
   ...
   ffNN_avgWeightChangesSq_updated ...
   ffNN_immedWeightGradsMemory_updated ...
   ...
   ffNN_avgWeightChangesSq_init = {}, ...
   ffNN_immedWeightGradsMemory_init = {}, ...
   ...
   if isempty(ffNN_avgWeightChangesSq_init)
      ffNN_avgWeightChangesSq_updated = ...
         zeros_ffNN_weightDimSizes;
      ffNN_avgWeightChangesSq_startAtZero...
   ...
   if isempty(ffNN_immedWeightGradsMemory_init)
      ffNN_immedWeightGradsMemory_updated = ...
         zeros_ffNN_weightDimSizes;
   else
      ffNN_immedWeightGradsMemory_updated = ...
      ...
      for (batch = 1 : trainNumBatches)
         ...
         targetOutputs_areClassIndcsColVecs_ofNumClasses, ...
               ...
               for (l = 1 : numTransforms)
                  ...
                  stepRates_adapt{l} = ...
                  sqrt(ffNN_avgWeightChangesSq_updated{l} ...
                     + offsetTerm) ...
